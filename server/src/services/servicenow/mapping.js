...
// TM2.0 test_type values generated by the pipeline -> ServiceNow-compatible values.
// If your instance uses numeric choice values, replace these values accordingly.
const TM20_TEST_TYPE_TO_SERVICENOW = {
...
export function mapTM20TestTypeToServiceNow(testType) {
  return TM20_TEST_TYPE_TO_SERVICENOW[testType] ?? 'Functional';
}
